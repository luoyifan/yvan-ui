...
export type GridDataSourceSave =
  | undefined
  | GridDataSourceSaveStatic
  | GridDataSourceSaveStaticFunction
...
export interface GridDataSourceSaveStatic {
  type: 'function'
  bind: string // 指向当前模块类型为 GridDataSourceSaveStaticFunction 的方法
}

export type GridDataSourceSaveStaticFunction = (
  sender: CtlGrid,
  params: GridDataSourceSaveStaticFunctionParam
) => void
...
export type GridDataSourceStaticFunction = (
  sender: CtlGrid,
  params: GridDataSourceStaticFunctionParam
) => void
